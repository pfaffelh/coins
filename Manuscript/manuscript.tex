...
\begin{proof}[Joint proof of Lemmas~\ref{lem:collapse},
  ...
  \]
  By IH(b), $c_{n-1}-\tfrac{27}{16}\ge 0$; one checks
  $0<B_n<1$ for all $n\ge 7$.  For $n\in\{7,\dots,12\}$, the
  ...
  cumulatively: define $\varepsilon_m:=c_m-\tfrac{27}{16}$,
  so~(d) gives $\varepsilon_m=(1-B_m)\varepsilon_{m-1}+(A_m-\tfrac{27}{16}B_m)$.
  ...
  is bounded by $\sum_{k\ge 13}\tfrac{3(k^2-15k+36)}{32\cdot 2^k}
