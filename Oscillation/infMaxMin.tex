% =====================================================================
% DEPRECATED (2026-05-21).  Superseded by Oscillation/manuscript.tex,
% which is the Paper 2 manuscript of record.  This file is kept only as
% a development record; do not extend it.
% =====================================================================
...
\fbox{\parbox{0.9\linewidth}{\centering
  \textbf{DEPRECATED.}
  This development note has been superseded by the unified Paper~2
  manuscript \texttt{Oscillation/manuscript.tex}, which is now the
  paper of record. It is kept only as a development record --- its
  detailed proofs may assist when migrating content into the
  manuscript --- and is no longer maintained.}}
\end{center}
\bigskip
